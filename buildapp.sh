...
# Check uYou
if 	[ ! -f Tweaks/uYou/com.miro.uyou_2.3_iphoneos-arm.deb ]
then
	echo -e "==> \033[1muYou v2.3 is not found. Downloading uYou (v2.3)...\033[0m"
	(set -x ; curl https://miro92.com/repo/debs/com.miro.uyou_2.3~1_iphoneos-arm.deb --output Tweaks/uYou/com.miro.uyou_2.3_iphoneos-arm.deb)
else
...
if 	(cd Tweaks/uYou && tar -xf com.miro.uyou_2.3_iphoneos-arm.deb && tar -xf data.tar.*)
then
...
# Clean up	
	...
	find Tweaks/uYou -mindepth 1 ! -name "com.miro.uyou_2.3_iphoneos-arm.deb" ! -name ".gitkeep" -exec rm -rf {} \; 2>/dev/null
